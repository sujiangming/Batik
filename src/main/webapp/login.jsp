...
<head>
	...
	<script type="text/javascript">
		...
		function login() {
			...
			//调用登录接口
			$.ajax({
				url : "http://localhost:8080/Batik_war/login",
				type : "POST",
				data : data,
				dataType : "json",
...
<div style="margin: 0 auto;width: 30%;height: 50%;margin-top: 7%;border-radius: 12px;
	...
	<div onclick="login()" style="width: 100%;margin-top: 48px;color: white;font-size: 18px;">
		<b>登录</b>
	</div>
	...
	<div>
		<div style="margin-top: 70px;height: 35px;width: 100%;text-align: center;">
			<div style="margin: 0 auto;height: 100%;line-height: 35px;width: 60%;text-align: center;background: #11298D;border-radius: 5px;color: white;">
				<b>登录</b>
			</div>
		</div>
	</div>
